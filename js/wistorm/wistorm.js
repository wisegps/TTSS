...
// 返回:
//    status_code: 状态码
WiStormAPI.prototype._sysGet = function (table, query_json, fields, access_token, callback) {
    this.init();
	this.sign_obj.method = 'wicare.' + table + '.get';
    this.sign_obj.access_token = access_token;
    for (var key in query_json) {
...
var app_key = "fb307630acdbb26529dbf7bd437dce59";
var app_secret = "30358b573d19d66c5f7e001fa67122a2";
